  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        backgroundColor: "var(--tableContainerWhite-bg)",
        boxSizing: "border-box",
        height: "100%",
        position: "relative",
      }}
    ...
    >
      <style>{`
        ...
        html.dark-mode input.leftNavInput,
        html.dark-mode select.leftNavInput {
          border: 0.5px solid var(--gray-500) !important;
        }
        
        html.dark-mode .totalExclDisplay,
        html.dark-mode .navBarButton {
          background-color: var(--tableContainer-bg) !important;
          border-color: var(--gray-500) !important;
        }
      `}</style>
      <div style={{ padding: "1rem 1rem 1rem 0" }}>
        <div style={topHeadingStyle}>Settings</div>
        <div>
        ...
        <div>
          <label style={fieldLabelStyle}>Calculation Type</label>
          <select
        ...
        <div>
          <label style={fieldLabelStyle}>Programme</label>
          <select
          ...
          >
            ...
            <option value="Link to Fee Proposal">Link to Fee Proposal</option>
        ...
        <div style={{ display: "flex", alignItems: "center", marginBottom: "1rem" }}>
          ...
          <span style={{ marginLeft: "8px", fontSize: "13px", fontWeight: "normal", color: "var(--text-color)" }}>
            Taxation
          </span>
        </div>
        <div>
